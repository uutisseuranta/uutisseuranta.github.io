...
| 9 | Pull Request | PR-numero, branch, status | `development`-kenttä | GitHub | ✅ natiivi GitHub for Jira | ⛔ | Natiivi kattaa |
...
> **Trigger-nimi:** Atlassian Automation -triggerit ovat "Sprint created, started, or completed"
> (sprint-tason trigger) sekä "Field value changed" → Sprint (issue-tason trigger).
> Käytä jälkimmäistä kun haluat reagoida yksittäisen work itemin sprinttimuutokseen.
...
| `{{issue.sprint.name}}` | Aktiivisen sprintin nimi | Vain Scrum-projekteissa |
...
| 2 | Asenna GitHub for Jira -app ja liitä repot (kehityspaneeli) | ✅ VALMIS |
